...
<div class="container ">
    <div class="row ml-10">
     ...
     <button class="text-blue-600 font-bold text-xl underline decoration-dashed">Select File to Upload  MCA Question Paper:</button> <br> <br>      
        ...
        <div class="col-xs-8 col-xs-offset-2 ml-1">
            <table class="table table-striped table-hover ">
                ...
                <tr>
                    ...
                    <td class="underline text-blue-500 pb-6"><br><a href="uploadmca/<?php echo $row['filename']; ?>" target="_blank">View</a></td>
                    <td class="underline  text-blue-500 "><a href="uploadmca/<?php echo $row['filename']; ?>" download>Download</td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
    ...
    <a href="displayuser.php">
            ...
            <a href="index5.php">
            <button class="btn text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 text-sm rounded-lg  my-2  px-2 py-4 font-extralight  font-mono w-fit">upload gate question paper</button></a>
        </div>
        </div>
</body>
</html>
