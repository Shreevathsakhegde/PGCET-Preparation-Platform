        ...
        <div class="col-xs-8 col-xs-offset-2 ml-24">
            <table class="table table-striped table-hover ">
                ...
                <tr>
                    ...
                    <td class="underline text-blue-500 pb-6"><br><a href="uploadset1/<?php echo $row['filename']; ?>" target="_blank">View</a></td>
                    <td class="underline  text-blue-500 "><a href="uploadset1/<?php echo $row['filename']; ?>" download>Download</td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
