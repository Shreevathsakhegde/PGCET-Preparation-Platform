...
<div class="container ">
    <div class="row ml-10">
     ...
     <button class="text-blue-600 font-bold text-xl underline decoration-dashed">Select File to Upload NET Question Paper:</button> <br> <br>      
        ...
        <div class="col-xs-8 col-xs-offset-2 ml-1">
            <table class="table table-striped table-hover ">
                ...
                <tr>
                    ...
                    <td class="underline text-blue-500 pb-6"><br><a href="uploadnet/<?php echo $row['filename']; ?>" target="_blank">View</a></td>
                    <td class="underline  text-blue-500 "><a href="uploadnet/<?php echo $row['filename']; ?>" download>Download</td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
