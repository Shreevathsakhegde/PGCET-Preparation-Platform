<?php
   ...
   //Content
    ...
    $mail->Body    = 'This is the HTML message body <b>http://localhost/php/passreset.php</b>';
    $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';

    $mail->send();

    echo "<script> alert('Message Has Been Sent To Your Gmail '),location.href='login.php';</script>";
